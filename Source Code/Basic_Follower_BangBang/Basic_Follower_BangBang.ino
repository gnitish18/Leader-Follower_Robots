...
void lpid()
{
  ...
  //if(lrpm<(0.3*setlrpm))
    //lsp=255;
  //else if((lrpm>=(0.3*setlrpm))&&(lrpm<=(1.3*setlrpm)))
    {
      lsp=lpre_ocr+((255.0/400.0)*(ldif))+lkd*ldd;
      lpre_ocr=lsp;
    }
  //else 
    //lsp=0;
...
void rpid()
{
  ...
  //if(rrpm<(0.3*setrrpm))
    //rsp=255;
  //else if((rrpm>=(0.3*setrrpm))&&(rrpm<=(1.3*setrrpm)))
    {
      rsp=rpre_ocr+((255.0/400.0)*(rdif))+rkd*rdd;
      rpre_ocr=rsp;
    }
  //else 
    //rsp=0;
